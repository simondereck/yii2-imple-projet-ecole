    ...
    <nav class="admin-nav">
        ...
        <div class="admin-nav-content">
            ...
            <ul href="index.php?r=admin/index">
                ...
                <ul>
                    <li href="index.php?r=admin/update">Modifier un compte</li>
                </ul>
            </ul>
            <ul>
                <h5>Gestion de RDV</h5>
                <ul>
                    <li href="index.php?r=rdv/index">RDV en ligne</li>
                </ul>
            </ul>
            <ul>
                <h5>Components</h5>
                <ul>
                    <li href="index.php?r=components/inscription">Mon inscription</li>
                    <li href="index.php?r=student/mon_cours">cours optionnels</li>
                    <li>Notes scolaires</li>
                    <li href="index.php?r=components/telecharger">télécharger</li>
                </ul>
            </ul>
            <ul>
                <h5>Extra</h5>
                <ul>
                    <li href="index.php?r=site/contact">Contactez nous</li>
                    <li href="index.php?r=site/logout">Déconnexion</li>
                </ul>
            </ul>
        </div>
