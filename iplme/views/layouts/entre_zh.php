...
<div class="wrap">
    <?php $this->beginContent('@app/views/layouts/header_zh.php') ?>
    <?php $this->endContent() ?>
        ...
        <div class="second-nav-div">
            <nav class="second-nav">
                <ul class="second-nav-ul">
                    <li data-href="index">概况</li>
                    <li data-href="cooperation">合作</li>
                    <li data-href="talent">提高</li>
                    <li data-href="soutenez">支持我们</li>
                </ul>
            </nav>
        </div>
        <?= $content ?>
...
<?php $this->beginContent('@app/views/layouts/footer_zh.php'); ?>
<?php $this->endContent(); ?>

<script>
    $('.second-nav-ul').on('click','li',function () {
        let val = $(this).attr('data-href');
        window.location = 'index.php?r=entreprise/'+val;
    });
