        ...
        <div class="second-nav-div">
            <nav class="second-nav">
                <ul class="second-nav-ul">
                    <li data-href="index">学校简介</li>
                    <li data-href="presentation">院系设置</li>
                    <li data-href="vision">使命愿景</li>
                    <li data-href="campus">学院地图</li>
                    <li data-href="professeur">学院师资</li>
                    <li data-href="contact">联系我们</li>
                </ul>
            </nav>
        </div>
        <?= $content ?>
